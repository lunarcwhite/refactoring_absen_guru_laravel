    ...
    var e, t = {
            ...
            750: () => {
                ...
                function n(e, t, n, i) {
                    ...
                    var o, r = window.getComputedStyle(e),
                ...
                var i = function () {
                        ...
                        return o = i, (r = [{
                            ...
                            value: function () {
                                ...
                                for (var t = document.querySelectorAll(".sidebar-item.has-sub"), i = function () {
                                        var i = t[o];
                                        t[o].querySelector(".sidebar-link").addEventListener("click", (function (t) {
                                            t.preventDefault();
                                            var o, r, l, a = i.querySelector(".submenu");
                                            a.classList.contains("active") && (a.style.display = "block"), "none" == a.style.display ? a.classList.add("active") : a.classList.remove("active"), r = 300, l = function () {
                    ...
                    return function (e) {
                        ...
                        "./node_modules/core-js/internals/array-from.js": function (e, t, n) {
                            ...
                            e.exports = function (e) {
                                var t, n, p, d, h = o(e),
                                    ...
                                    m = 0,
                                    g = c(h);
                                if (x && (f = i(f, y > 2 ? arguments[2] : void 0, 2)), null == g || u == Array && l(g))
                                    for (n = new u(t = a(h.length)); t > m; m++) s(n, m, x ? f(h[m], m) : h[m]);
                                else
                                    for (d = g.call(h), n = new u; !(p = d.next()).done; m++) s(n, m, x ? r(d, f, [p.value, m], !0) : p.value);
                                return n.length = m, n
                            }
                        },
                        ...
                        "./node_modules/core-js/internals/define-iterator.js": function (e, t, n) {
                            ...
                            e.exports = function (e, t, n, p, u, b, w) {
                                ...
                                if (Y && (_ = r(Y.call(new e)), y !== Object.prototype && _.next && (d || r(_) === y || (l ? l(_, y) : "function" != typeof _[x] && s(_, x, j)), a(_, L, !0, !0), d && (h[L] = j))), u == g && z && z.name !== g && (H = !0, O = function () {
                                        return z.call(this)
                                    }), d && !w || S[x] === O || s(S, x, O), h[t] = O, u)
                                    if (M = {
                                            values: A(g),
                                            keys: b ? O : A(m),
                                            entries: A(v)
                                        }, w)
                                        for (k in M)(f || H || !(k in S)) && c(S, k, M[k]);
                                    else i({
                                        target: t,
                                        proto: !0,
                                        forced: f || H
                        ...
                        "./node_modules/core-js/internals/export.js": function (e, t, n) {
                            ...
                            e.exports = function (e, t) {
                                var n, p, d, h, u, y = e.target,
                                    f = e.global,
                                    x = e.stat;
                                if (n = f ? i : x ? i[y] || a(y, {}) : (i[y] || {}).prototype)
                                    for (p in t) {
                        ...
                        "./node_modules/core-js/internals/internal-state.js": function (e, t, n) {
                            var i, o, r, l = n("./node_modules/core-js/internals/native-weak-map.js"),
                        ...
                        "./node_modules/core-js/internals/iterators-core.js": function (e, t, n) {
                            "use strict";
                            var i, o, r, l = n("./node_modules/core-js/internals/object-get-prototype-of.js"),
                        ...
                        "./node_modules/core-js/internals/object-create.js": function (e, t, n) {
                            ...
                            e.exports = Object.create || function (e, t) {
                                var n;
                                return null !== e ? (p.prototype = i(e), n = new p, p.prototype = null, n[c] = e) : n = d(), void 0 === t ? n : o(n, t)
                            }, l[c] = !0
                        },
                        "./node_modules/core-js/internals/object-define-properties.js": function (e, t, n) {
                            ...
                            e.exports = i ? Object.defineProperties : function (e, t) {
                                r(e);
                                for (var n, i = l(t), a = i.length, s = 0; a > s;) o.f(e, n = i[s++], t[n]);
                                return e
                            }
                        },
                        ...
                        "./node_modules/core-js/internals/object-keys-internal.js": function (e, t, n) {
                            ...
                            e.exports = function (e, t) {
                                var n, r = o(e),
                                    s = 0,
                                    c = [];
                                for (n in r) !i(l, n) && i(r, n) && c.push(n);
                                for (; t.length > s;) i(r, n = t[s++]) && (~a(c, n) || c.push(n));
                                return c
                            }
                        },
                ...
                e.exports = function () {
                    ...
                    var L = {
                        ...
                        z = function (e, r) {
                            ...
                            for (var a in this.element = e, e.classList.add(w.main), this.settings = H(), r) this.settings[a] = r[a];
    ...
    i.m = t, e = [], i.O = (t, n, o, r) => {
        if (!n) {
            ...
            for (p = 0; p < e.length; p++) {
                for (var [n, o, r] = e[p], a = !0, s = 0; s < n.length; s++)(!1 & r || l >= r) && Object.keys(i.O).every((e => i.O[e](n[s]))) ? n.splice(s--, 1) : (a = !1, r < l && (l = r));
                if (a) {
                    e.splice(p--, 1);
                    var c = o();
                    void 0 !== c && (t = c)
