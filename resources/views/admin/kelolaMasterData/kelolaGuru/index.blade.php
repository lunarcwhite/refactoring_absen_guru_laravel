...
<div class="row">
    <div class="col">
        ...
        <div class="button-group">
            <button type="button" onclick="clearInput('formGuru','Tambah Guru',`dashboard/kelolaGuru`, true)" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#modalFormGuru">
                Tambah
              </button>
