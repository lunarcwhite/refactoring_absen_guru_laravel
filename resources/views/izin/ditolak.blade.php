    ...
    <div class="col">
        <div class="table-responsive">
            <table class="table table-hover" id="myTable">
                ...
                <tbody>
                    @foreach ($ditolaks as $no => $ditolak)
                        <tr>
                            <td>{{$no+1}}</td>
                            <td>{{$ditolak->tanggal_untuk_pengajuan}}</td>
                            <td>{{$ditolak->tipe}}</td>
                            <td>{{$ditolak->user->nama}}</td>
                            <td><span class="badge bg-danger">Ditolak</span></td>
                            <td><button onclick="openModal('modal-lihat-pengajuan',{{$ditolak->id}})" type="button" class="badge bg-info">Lihat</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer" id="modal-button">
                    <button type="button" onclick="konfirmasi('1')" class="btn btn-success" >Setujui Pengajuan</button>
                </div>
            </form>
            </div>
        </div>
